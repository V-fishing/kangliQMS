...
const MENU_TREE: MockMenuItem[] = [
  {
    ...
    children: [
      ...
      { path: 'trigcfg', name: 'FiaTrigCfg', title: '触发与签名配置', icon: '⚙', module: 'fia', component: 'fia/TrigCfg' },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'paramcfg', name: 'SpcParamCfg', title: '参数配置', icon: '⚙', module: 'spc', component: 'spc/ParamCfg' },
      { path: 'rulecfg', name: 'SpcRuleCfg', title: '判异规则', icon: '📐', module: 'spc', component: 'spc/RuleCfg' },
    ],
  },
  {
    path: 'ncm',
  ...
  },
  {
      ...
      children: [
        ...
        { path: 'trace', name: 'SqmTrace', title: '来料追溯', icon: '🔗', module: 'sqm', component: 'sqm/Trace' },
